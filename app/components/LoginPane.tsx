  ...
  return (
    <div className='flex flex-row w-[50rem] h-[35rem] bg-white/90 backdrop-blur-sm rounded-2xl drop-shadow-md p-4'>
      <div className='basis basis-3/5'>
        {isSignup ? (
          <div className="flex flex-col mr-8 rounded-2xl h-full bg-black/40 bg-[url('../public/images/signup.jpg')] bg-cover bg-center bg-blend-darken p-7 pb-8 justify-end">
